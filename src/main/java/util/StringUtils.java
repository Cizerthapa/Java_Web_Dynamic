...
public class StringUtils {
	...
	public static final String INSERT_STUDENT = "INSERT INTO `student` (`user_name`, `fName`, `lName`, `dob`, `gender`, `email`, `phone`, `subject`, `password`) VALUES (?,?,?,?,?,?,?,?,?)";
	
	public static final String GET_LOGIN_STUDENT_INFO = "SELECT * from student Where user_name = ? AND password = ?";
	
	public static final String GET_ALL_STUDENT_INFO = "SELECT * FROM student_info";
	
	public static final String GET_ALL_STUDENT_USERNAME = "SELECT user_name FROM student_info WHERE ";
	
	public static final String GET_USERNAME = "SELECT `user_name` FROM `student` WHERE user_name = ?";
	
	public static final String GET_PHONE = "SELECT `phone` FROM `student` WHERE phone = ?";
	
	public static final String GET_EMAIL = "SELECT email FROM student_info WHERE email = ?";
